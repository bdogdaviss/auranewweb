...
// Registering the plugin is a no-op on subsequent calls, so module-init is fine
// even with HMR re-evaluations.
...
const ScrollFloat = ({
  ...
  useEffect(() => {
    ...
    // Strict-mode + HMR safety: kill the trigger/tween on unmount so we don't
    // leak ScrollTriggers across renders.
    return () => {
